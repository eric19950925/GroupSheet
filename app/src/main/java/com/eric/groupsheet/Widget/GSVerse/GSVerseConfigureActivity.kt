...
class GSVerseConfigureActivity : AppCompatActivity() , GSVController{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        styleList.add(StyleClass("style1","科技前沿","冷色系/暗黑",R.drawable.icons8_info,false))
        ...
        styleList.add(StyleClass("style6","大亨小傳","華麗/獨特",R.drawable.icons8_info,false))
        styleList.add(StyleClass("style7","光輝燦爛","搶眼/明顯",R.drawable.icons8_info,false))
