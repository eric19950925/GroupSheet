...
class EditRule: BaseFragment(),
    ...
    override fun initView() {
        ...
        tv_add_plan.setOnClickListener {
            Toast.makeText(context,"功能開發中", Toast.LENGTH_LONG)
            /*尚未完成的功能:拍照與搜尋清單
            val EditSheetView : View = getLayoutInflater().inflate(R.layout.dialog_add_plan,null)
            val img_search: ImageView = EditSheetView.findViewById(R.id.imgSearch)
            val img_camera: ImageView = EditSheetView.findViewById(R.id.imgCam)
            val builder = activity?.let { it1 -> androidx.appcompat.app.AlertDialog.Builder(it1) }
    ...
    companion object{
        ...
        fun newInstance(sheetId: String) = EditRule()
            .apply {
