...
class EditSheet:BaseFragment() ,SheetDataController,SheetDataNameController,
    ...
    override fun initObserver() {
        ...
        observe(viewModel.SheetData){
            ...
            sheetDataAdapter = viewModel.SheetData.value?.let { SheetDataAdapter(it,this) }!!
            rv_sheetData.adapter = sheetDataAdapter
            sheetDataAdapter.notifyDataSetChanged()
            sheetDataNameAdapter = viewModel.SheetData.value?.let { SheetDataNameAdapter(it,this) }!!
    ...
    override fun initView() {
        ...
        val sheetDataAdapter = viewModel.SheetData.value?.let { SheetDataAdapter(it,this) }
        rv_sheetData.adapter = sheetDataAdapter

        rv_name.setHasFixedSize(true)
        rv_name.layoutManager = LinearLayoutManager(context)
        val sheetDataNameAdapter = viewModel.SheetData.value?.let { SheetDataNameAdapter(it,this) }
    ...
    companion object{
        ...
        fun newInstance(sheetId: String) = EditSheet().apply {
